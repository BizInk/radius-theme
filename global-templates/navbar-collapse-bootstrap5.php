	...
	<div class="<?php echo esc_attr( $container ); ?>">
		...
		if ( empty($main_logo)) {
			...
			if ( is_front_page() && is_home() ) : ?>
				...
				<h1 class="navbar-brand mb-0"><a rel="home" href="<?php echo esc_url( home_url( '/' ) ); ?>" itemprop="url"><?php echo bloginfo( 'name' ); ?></a></h1>

			<?php else : ?>

				<a class="navbar-brand" rel="home" href="<?php echo esc_url( home_url( '/' ) ); ?>" itemprop="url"><?php echo bloginfo( 'name' ); ?></a>
