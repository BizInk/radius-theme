	...
	*/
	...
	jQuery(document).ready(function ($) {
	  ...
	  if (window.matchMedia("(max-width:992px)").matches) {
	    jQuery("header .top-nav .btn").insertAfter(jQuery(".navbar-collapse > ul"));
	  }
	  ...
	  if (jQuery(document).find('.four-col-team-section').length > 0) {
	  ...
	  if (jQuery(window).width() > 767) {
	    jQuery(window).on('load resize', function () {
	      ...
	      var checklistDescription = 0;
	      var latestpostslider = 0; //Calculating the description new height
	      ...
	      jQuery('.latest-post-slider h4').each(function () {
	        if (infoboxDescription < jQuery(this).outerHeight()) {
	          infoboxDescription = jQuery(this).outerHeight();
	        }
	      }); //Calculating the description new height
	      ...
	      jQuery('.latest-post-slider h4').css({
	        'min-height': latestpostslider
	      });
	    });
